...
This project uses **Node.js** as its runtime and **pnpm** as its package manager. Use `pnpm` for all project commands (e.g. `pnpm dev`, `pnpm build`, `pnpm check`, `pnpm install`).
